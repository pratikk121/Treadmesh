// Pages/Admin/SupplierVerification/Verified.jsx
...
export default function Verified({ verifiedSuppliers }) {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    router.get(route('admin.supplier-verification.verified'), {
      search: searchTerm
    }, { preserveState: true });
  };
  ...
  return (
    <DashboardLayout>
      ...
      <div className="space-y-6">
        ...
        {/* Suppliers Grid - Card layout for verified suppliers */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {verifiedSuppliers.data.map((supplier) => (
        ...
        {verifiedSuppliers.links && (
          <div className="flex justify-center gap-2 mt-6">
            {verifiedSuppliers.links.map((link, index) => (
              <button
                key={index}
